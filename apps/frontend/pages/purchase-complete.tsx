    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-reviewdrumLightGray">
            <div className="w-full md:w-3/5 lg:w-2/5 bg-white shadow-md p-8 rounded-lg">
                ...
                <p className="mb-4">{`We're thrilled to have you onboard and are excited to work with you.  You're content will be available in the deliveries page within the next 7 days.  We'll reach out by email once its ready.`}</p>
