...
import { Clinic, ClinicSchema } from '@monorepo/type';
...
@Module({
    ...
    controllers: [ClinicController, AdSetController, ReviewController, PositiveDescriptorController, ClaimController],
    providers: [
        ClinicModelService,
        AdSetModelService,
        ReviewModelService,
